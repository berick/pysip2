...
FixedFieldSpec.circ_status.OTHER = '01'
FixedFieldSpec.circ_status.ON_ORDER = '02'
FixedFieldSpec.circ_status.AVAILABLE = '03'
FixedFieldSpec.circ_status.CHARGED = '04'
FixedFieldSpec.circ_status.CHARGED_NOT_RECALLED = '05'
FixedFieldSpec.circ_status.IN_PROCESS = '06'
FixedFieldSpec.circ_status.RECALLED = '07'
FixedFieldSpec.circ_status.ON_HOLD_SHELF = '08'
FixedFieldSpec.circ_status.WAITING_FOR_RESHELF = '09'
